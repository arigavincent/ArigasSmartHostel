    ...
    <div class="container mx-auto p-6">
        ...
        <div class="bg-white rounded-lg shadow-md p-6 mb-6">
            <h2 class="text-2xl font-bold text-gray-800 mb-4">
                <i class="fas fa-tachometer-alt text-indigo-600 mr-2"></i>Dashboard
            </h2>
                    ...
                    <div class="ml-4">
                        ...
                        <?php if (!empty($current_booking)): ?>
                            <?php if ($current_booking['payment_status'] === 'paid'): ?>
                                <p class="text-green-600 font-semibold">Paid in full</p>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
            <a href="index.php?url=student/rooms" class="bg-indigo-600 hover:bg-indigo-700 text-white p-4 rounded-lg text-center transition duration-300">
                <i class="fas fa-search text-2xl mb-2"></i>
                <p class="font-semibold">Browse Rooms</p>
            </a>

            <a href="index.php?url=student/bookings" class="bg-green-600 hover:bg-green-700 text-white p-4 rounded-lg text-center transition duration-300">
                <i class="fas fa-calendar-check text-2xl mb-2"></i>
                <p class="font-semibold">My Bookings</p>
            </a>

            <a href="index.php?url=student/payments" class="bg-yellow-600 hover:bg-yellow-700 text-white p-4 rounded-lg text-center transition duration-300">
                <i class="fas fa-receipt text-2xl mb-2"></i>
                <p class="font-semibold">Payments</p>
            </a>

            <a href="index.php?url=student/profile" class="bg-gray-600 hover:bg-gray-700 text-white p-4 rounded-lg text-center transition duration-300">
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            <h3 class="text-xl font-bold text-gray-800 mb-4">
                <i class="fas fa-user-circle text-indigo-600 mr-2"></i>Your Information
            </h3>
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            <h3 class="text-xl font-bold text-gray-800 mb-4">
                <i class="fas fa-calendar-alt text-indigo-600 mr-2"></i>My Bookings
            </h3>
            <div class="ml-4">
